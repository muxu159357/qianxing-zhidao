...
<template>
  <div class="ak-page">
    <div class="ph"><h2 class="pt">知识库管理</h2><div class="ha"><el-input v-model="keyword" placeholder="搜索问题" clearable style="width:240px" @keyup.enter="onSearch"/><el-button type="primary" @click="onSearch">搜索</el-button><el-button @click="load">刷新</el-button><el-button type="success" @click="openNew">新增文章</el-button></div></div>
    <el-card shadow="never">
      ...
      <div v-if="!loading&&articles.length===0" class="eh">暂无数据</div>
